classdef Encoder < handle
	...
	methods
		...
		function obj = LoadExampleCellsActivities(obj, sbj, dataFile)
						...
						switch(lower(classifier))							
							...
							case 'thresholding-uni-no_bias'
								...
								if( k > 1 )
				                    ...
				                    if(err < 1e-12)
				                        thresholdAcc{iCond,iL} = prctile( y(T==0), 100 - x(k) );
				                    else
				                        thresholdAcc{iCond,iL} = (prctile(y(T==0), 100-x(k)) + prctile(y(T==1), x(k))) / 2;
				                    end
