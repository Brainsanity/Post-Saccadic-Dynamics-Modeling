function val = totalRGCRFDensityAlongMeridian(obj, eccentricities, rightEyeVisualFieldMeridianName, eccUnits, densityUnits)
    ...
    % % Make sure eccentricities is a 1xN vector        %%%%%% YB.2020.07.10. Keep the shape of eccentricities. %%%%%%
    ...
    %%%%%% YB. 2020.07.03. Simplify the code. %%%%%%
    peakConeDensity = obj.dc0;
    if (strcmpi(densityUnits, obj.retinalMMDensityUnits))
        peakConeDensity = peakConeDensity / obj.alpha(0);
    end
