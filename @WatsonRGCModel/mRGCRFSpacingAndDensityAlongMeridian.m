...
%                       superior at 90, nasal at 18, & inferior at 270 degs
    ...
    midgetRGCFractionAlongMeridian = percentageOfMidgetRGCsAtZeroEccentricity ./ (1 + eccDegs/41.0256);         %%%%%% YB. 2020.07.03. Change 41.03 to 41.0256 according to equation 7 in the Drasto (2007) paper
    ...
    switch(p.Results.subtype)
        case 'ON'
            ...
            mRGCRFDensity = obj.OnOffRatio(eccDegs, 'POn') .* mRGCRFDensity;      %%%%%% YB. 2020.07.03 %%%%%%
        case 'OFF'
            % mRGCRFDensity = 0.5*mRGCRFDensity;
            mRGCRFDensity = obj.OnOffRatio(eccDegs, 'POff') .* mRGCRFDensity;            %%%%%% YB. 2020.07.03 %%%%%%
        case 'ONOFF'
            % do nothing
        otherwise
