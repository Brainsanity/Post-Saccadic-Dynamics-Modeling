...
function fitRawData(obj)
    ...
    for( k = 1 : 2 )
        ...
        [obj.([Cell{k} 'CenterRadiusFunction']), obj.([Cell{k} 'CenterRadiusParams']), obj.([Cell{k} 'CenterRadiusParamsSE'])] = nonLinearFitData(x, y, [], [], obj.([Cell{k} 'CenterData'])('size').initialParams, obj.fitIntercept, minY(k,1));

        x = obj.([Cell{k} 'SurroundData'])('size').eccDegs;
        y = obj.([Cell{k} 'SurroundData'])('size').radiusDegs;
        [obj.([Cell{k} 'SurroundRadiusFunction']), obj.([Cell{k} 'SurroundRadiusParams']), obj.([Cell{k} 'SurroundRadiusParamsSE'])] = nonLinearFitData(x, y, [], [], obj.([Cell{k} 'SurroundData'])('size').initialParams, obj.fitIntercept, minY(k,2));
        
        x = obj.([Cell{k} 'CenterData'])('sensitivity').radiusDegs;
        y = obj.([Cell{k} 'CenterData'])('sensitivity').peakSensitivity;
        [obj.([Cell{k} 'CenterPeakSensitivityFunction']), obj.([Cell{k} 'CenterPeakSensitivityParams']), obj.([Cell{k} 'CenterPeakSensitivityParamsSE'])] = nonLinearFitData(x, y, [], [], obj.([Cell{k} 'CenterData'])('sensitivity').initialParams, obj.fitIntercept, minY(k,3));

        x = obj.([Cell{k} 'SurroundData'])('sensitivity').radiusDegs;
        y = obj.([Cell{k} 'SurroundData'])('sensitivity').peakSensitivity;
        [obj.([Cell{k} 'SurroundPeakSensitivityFunction']), obj.([Cell{k} 'SurroundPeakSensitivityParams']), obj.([Cell{k} 'SurroundPeakSensitivityParamsSE'])] = nonLinearFitData(x, y, [], [], obj.([Cell{k} 'SurroundData'])('sensitivity').initialParams, obj.fitIntercept, minY(k,3));
    end
end
...
function usePaperFits(obj)
    ...
    [obj.PCenterRadiusFunction, obj.PCenterRadiusParams, obj.PCenterRadiusParamsSE] = nonLinearFitData(x, yMedian, yIQR, ySamplesNum, obj.PCenterData('size').initialParams, obj.fitIntercept, minY(1));
...
function fitMedianData(obj)
    ...
    for( k = 1 : 2 )
        ...
        [obj.([Cell{k} 'CenterRadiusFunction']), obj.([Cell{k} 'CenterRadiusParams']), obj.([Cell{k} 'CenterRadiusParamsSE'])] = nonLinearFitData(x, yMedian, yIQR, ySamplesNum, obj.([Cell{k} 'CenterData'])('size').initialParams, obj.fitIntercept, minY(k,1));
        ...
        [obj.([Cell{k} 'SurroundRadiusFunction']), obj.([Cell{k} 'SurroundRadiusParams']), obj.([Cell{k} 'SurroundRadiusParamsSE'])] = nonLinearFitData(x, yMedian, yIQR, ySamplesNum, obj.([Cell{k} 'SurroundData'])('size').initialParams, obj.fitIntercept, minY(k,2));
        ...
        [obj.([Cell{k} 'CenterPeakSensitivityFunction']), obj.([Cell{k} 'CenterPeakSensitivityParams']), obj.([Cell{k} 'CenterPeakSensitivityParamsSE'])] = nonLinearFitData(x, yMedian, yIQR, ySamplesNum, obj.([Cell{k} 'CenterData'])('sensitivity').initialParams, obj.fitIntercept,minY(k,3));
        ...
        [obj.([Cell{k} 'SurroundPeakSensitivityFunction']), obj.([Cell{k} 'SurroundPeakSensitivityParams']), obj.([Cell{k} 'SurroundPeakSensitivityParamsSE'])] = nonLinearFitData(x, yMedian, yIQR, ySamplesNum, obj.([Cell{k} 'SurroundData'])('sensitivity').initialParams, obj.fitIntercept, minY(k,3));
    end
end


function [powerFunction, fittedParams, fittedParamsSE] = nonLinearFitData(x, y, yIQR, ySamplesNum, initialParams, fitIntercept, minY)
